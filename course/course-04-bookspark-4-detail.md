# Курс 4 (BookSpark) · 4-р хэсэг: Pages
## Номын дэлгэрэнгүй хуудас (dynamic route)

**⏱️ ~20 минут** · **Өмнөх:** `c04-3-components` · **Checkpoint:** `c04-4-detail`

> 🤖 **Хоёр зам:** **(A) Claude Code-д prompt өгч бүтээ** — [Prompt Pack → Part 4](course-04-bookspark-PROMPTS.md) (зөвлөнө). **(B)** Доорх кодыг хуул — fallback.
    ...
    <div className="mx-auto w-full max-w-4xl px-4 py-10">
      ...
      <div className="mt-6 grid grid-cols-1 gap-8 md:grid-cols-2">
        ...
        <div className="flex flex-col">
          ...
          {/* Энэ товч одоохондоо юу ч хийхгүй — QPay-г Курс 7-д холбоно. */}
          <button
            type="button"
          ...
          <p className="mt-2 text-xs text-slate-400">* Төлбөр (QPay)-г Курс 7-д холбоно.</p>
        </div>
      </div>
    </div>
  );
...
## 🚀 Deploy (заавал биш, гэхдээ зөвлөнө)
GitHub руу push → Vercel-д import → live URL. Дэлгэрэнгүйг Курс 4-ийн "Deploy to Vercel" хичээлээс. Live URL-аа **#ship-it-friday**-д хуваалц!

## 📦 Бэлэн код
- **ZIP:** `checkpoints/bookspark-c04-4-detail.zip`
- **Git:** `git checkout c04-4-detail`
...
*Дараагийн курс: **Курс 5 (BookSpark)** — номнуудаа Supabase database руу нүүлгэж, login + admin нэмнэ.*
